...
(define SOP-LIST
  (make-sop empty ;; Empty List
            (lambda (e) (list e)) ;; Singleton
            append ;; union of two sets
            (lambda (l1 l2)
                    (filter (lambda (e) (member? e l2)) l1));; intersection of two sets
            member? )) ;; is elemnt in the set?

(define SET1 ((sop-singleton SOP-LIST) 12)) ;; returns '(12)
(define SET2 ((sop-singleton SOP-LIST) 13)) ;; returns '(13)
(define SET3 ((sop-union SOP-LIST) SET1 SET2)) ;; returns '(12 13)
